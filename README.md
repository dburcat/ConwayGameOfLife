...
One interacts with the Game of Life by creating an initial configuration and observing how it evolves over many generations.

_(this is an alpha version of the python stubs.)_
